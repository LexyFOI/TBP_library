...
('neprijavljeni korisnik','pregled popisa knjiga'),
('clan knjižnice','rezervacija i pregled posudbi'),
('moderatot(knjižnièar)','upis knjiga i odobrenje posudbe'),
('admin','dodavanje novih korisnika i ureðivanje podataka o korisnicima');

INSERT INTO korisnik VALUES
('3','apolak','12-12-2018','Aleksandra','Polak','34567891234','apolak@gmail.com','A. Starèeviæa 6, 10000 Zagreb'),
('2','atomic','29-09-2017','Antonijo','Tomiæ','23456789123','atomic@gmail.com','Tea Ludviga 10 0001 Zagreb'),
('1','korisnik','21-08-2017','Ema','Watson','12345678912','ewatson@gmail.com','Marka Maruliæa 6, 10000 Zagreb'),
('1','korisnik2','21-08-2017','Ela','Watson','12345678912','ewatson2@gmail.com','Marka Maruliæa 6, 10000 Zagreb');

INSERT INTO posudba VALUES --posudba_id, primjerak_id, kor_ime, od_datum, do_datum, aktivna, produzeno
('1','2','01-08-2017','24-08-2017','2'), 
('2','2','10-08-2017','29-08-2017','1'),
('3','2','17-08-2017','31-08-2017','0');
...
('0','0','Profil','2001',1), 
('1','1','Algoritam','2001',0),  
('2','1','Znanje','2002',0),  
('2','1','Znanje','2000',0),
('3','0','Mozaik knjiga','1961',1),
('3','0','Mozaik knjiga','1961',1); 
